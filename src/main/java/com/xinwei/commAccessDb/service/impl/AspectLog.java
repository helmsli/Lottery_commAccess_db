...
public class AspectLog {
	...
	@Pointcut("execution(public * com.xinwei.commission.service..*.*(..))||execution(public * com.xinwei.lotteryDb.service..*.*(..))||execution(public * com.xinwei.commAccessDb.service..*.*(..))||execution(public * com.xinwei.commAccessDb.rest..*.*(..))")
